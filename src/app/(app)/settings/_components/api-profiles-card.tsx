        ...
        <CardHeader className="flex flex-row items-center justify-between">
          ...
          <div className="flex items-center gap-2">
            ...
            <Tooltip>
              ...
              <TooltipContent>{isProfilesOpen ? "Collapse API profiles" : "Expand API profiles"}</TooltipContent>
            </Tooltip>
          </div>
        </CardHeader>
        <CollapsibleContent>
                                                  ...
                                                  <TooltipTrigger asChild>
                                                      <span>
                                                          <AlertDialogTrigger asChild>
                                                              <Button variant="ghost" size="icon" className="h-8 w-8 text-destructive hover:text-destructive" disabled={isConnected} aria-label="Delete profile"><Trash2 className="h-4 w-4"/></Button>
                                                          </AlertDialogTrigger>
                                                      </span>
                                                  </TooltipTrigger>
