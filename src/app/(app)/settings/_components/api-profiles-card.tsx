            ...
            <Tooltip>
              <TooltipTrigger asChild>
                <CollapsibleTrigger asChild>
                  <Button variant="ghost" size="icon" className="h-8 w-8" aria-label={isProfilesOpen ? "Collapse API profiles" : "Expand API profiles"}>
                    <ChevronDown className={cn("h-4 w-4 transition-transform", isProfilesOpen && "rotate-180")} />
                    <span className="sr-only">Toggle</span>
                  </Button>
                </CollapsibleTrigger>
              </TooltipTrigger>
              <TooltipContent>{isProfilesOpen ? "Collapse" : "Expand"}</TooltipContent>
            </Tooltip>
          </div>
        </CardHeader>
        <CollapsibleContent>
                                  ...
                                  <TableCell className="text-right">
                                      <div className="flex items-center justify-end gap-2">
                                          ...
                                          <Tooltip>
                                            <TooltipTrigger asChild>
                                              <span>
                                                <Button variant="ghost" size="icon" className="h-8 w-8" onClick={() => openEditForm(profile)} disabled={isConnected} aria-label="Edit profile">
                                                ...
                                                <TooltipTrigger asChild>
                                                  <span>
                                                    <AlertDialogTrigger asChild>
                                                      <Button variant="ghost" size="icon" className="h-8 w-8 text-destructive hover:text-destructive" disabled={isConnected} aria-label="Delete profile">
