      ...
      <form onSubmit={form.handleSubmit(onSubmit)} className="space-y-4 pt-4">
        ...
        <div className="relative py-2">
         ...
         <div className="space-y-2">
            ...
            >
                <QrCode className="w-8 h-8 text-muted-foreground mb-2" aria-hidden="true" />
                <p className="text-sm text-muted-foreground">Click or press Enter to upload a QR code image</p>
                <Input type="file" ref={fileInputRef} onChange={handleFileChange} className="hidden" accept="image/*" tabIndex={-1} aria-hidden="true" />
            </div>
        </div>
