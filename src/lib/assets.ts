...
export const assetInfo: Record<string, string> = {
    ...
    "OM": "MANTRA", "NEWT": "Newt", "VIC": "VIC", "SPK": "Sparks"
};
...
export const fullAssetList = [
    ...
    "HBARUSDT", "ALGOUSDT", "EGLDUSDT", "FLOWUSDT", "CHZUSDT", "MINAUSDT", "OMUSDT", "NEWTUSDT", "VICUSDT", "SPKUSDT",
...
export const topBases = [
    ...
    "PEPE", "WIF", "TON", "ORDI", "WLD", "ARB", "OM", "NEWT", "VIC", "SPK"
].sort();
